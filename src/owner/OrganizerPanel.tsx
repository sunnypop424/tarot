  ...
  return (
    <section className="owner-section">
      ...
      <p className="t-text-xs t-muted" style={{ marginTop: 'var(--space-xs)' }}>
        {/*
          * 서비스 이름을 대지 않는다 — "타로와 럭키드로우" 라고 적어 뒀더니 서비스가 아홉이
          * 되면서 나머지 일곱을 쓰는 주최자에게는 자기 얘기가 아닌 글이 됐다. 슬롯마다
          * 서비스를 고르는 구조라(`src/data/services.ts`) 여기서 세면 셀 때마다 낡는다.
          */}
        슬롯을 <b>둘 이상</b> 맡으시는 주최자라면, 다른 슬롯에서 쓰던 <b>같은 이메일</b>을 넣어
