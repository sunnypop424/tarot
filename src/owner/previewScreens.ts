...
export const PREVIEW_SCREENS: Record<ServiceId, PreviewScreen[]> = {
  tarot: [
    { state: 'home', label: '홈' },
    { state: 'fortune', label: '운세', path: '/fortune' },
    { state: 'cards', label: '도감', path: '/cards' },
  ],
  luckydraw: [
    { state: 'draw', label: '뽑기' },
