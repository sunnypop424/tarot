...
export const STEPS = [
  ...
  },
  {
    no: '02',
    name: '디자인',
    desc: '그날의 컨셉에 맞춰 페이지를 새로 그려서 보내 드려요.',
    meta: '수정은 두 번까지예요',
  },
  {
    no: '03',
    name: 'QR 인쇄',
    desc: '관리 화면에서 QR을 바로 내려받아 포스터나 테이블 안내에 붙이면 준비 끝이에요.',
    meta: '인쇄용 크기로 직접 뽑아요',
  },
  {
    no: '04',
    name: '현장 운영',
    desc: '당일엔 그대로 쓰시면 돼요. 뭔가 이상하면 바로 알려 주세요.',
    meta: '행사 동안 연락 닿아요',
  },
]

/**
 * 두 목록은 화면에서 **나란히, 같은 번호로** 놓인다 (`Landing.tsx` 의 '제가 할게요' / '맡아 주세요').
 * 그래서 개수를 맞추고 **줄끼리 짝이 되게** 둔다 — 02 가 특히 그렇다:
 * 페이지는 이쪽이 그리지만 **로고·배경 이미지는 주최자가 준비해 주셔야 한다.**
 * (편집기에서 올리는 건 이쪽이지만 원본은 주최자에게서 온다 — `owner/*` 의 "주최자에게 받은
 * 이미지를 올려 주세요" 와 같은 이야기다. 이걸 안 적어 두면 시안 단계에서 멈춘다.)
 */
export const OURS = ['서비스 고르고 슬롯 만들기', '그날의 페이지 디자인', '주소 발급과 주최자 계정 만들기', '행사 동안 문제 생기면 손보기']
export const THEIRS = [
  '문항과 카드 내용 준비',
  '로고와 배경 이미지 준비',
  '경품 고르기와 재고 관리',
...
export const FAQS = [
  {
    q: '문의는 어떻게 하나요?',
    a: '카카오 오픈채팅으로 받아요. 페이지의 문의하기를 누르면 고른 서비스에 맞는 양식이 만들어져요 — 복사해서 채팅방에 붙여넣고 채워 보내 주시면 금액이랑 일정 알려 드려요. 들어오시면 방 별명을 "행사기간 / 멤버이름" 으로 바꿔 주세요.',
  },
  {
    /*
     * 커미션 사이트에서 제일 많이 받는 질문인데 답할 자리가 없었다.
     * **숫자는 안 적는다** — 금액은 정해져 있고, 문의를 받으면 알려 준다.
     */
    q: '얼마인가요?',
    a: '고른 서비스와 기간에 따라 정해진 금액이 있어요. 문의 주시면 바로 알려 드려요.',
  },
  {
    q: '앱을 설치해야 하나요?',
